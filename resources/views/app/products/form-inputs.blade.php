...
<div class="flex flex-wrap">
    <x-inputs.group class="w-full">
        <x-inputs.text name="title" label="Title" value="{{ old('title', $editing ? $product->title : '') }}"
    ...
    <x-inputs.group class="w-full">
        <x-inputs.text name="address" label="Address"
            value="{{ old('address', $editing ? $product->address : '') }}" maxlength="255" placeholder="Address"
    ...
    <x-inputs.group class="w-full">
        <x-inputs.number name="price" label="Price" value="{{ old('price', $editing ? $product->price : '') }}"
            placeholder="Price"></x-inputs.number>
    </x-inputs.group>
</div>
